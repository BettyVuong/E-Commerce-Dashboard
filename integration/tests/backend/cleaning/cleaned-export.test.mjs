/*
  cleaned-export.test.mjs

  Backend integration tests for cleaned-data export endpoint.
*/
...
export function defineTests(ctx) {
  return [
    {
      name: "backend cleaning export: returns downloadable workbook",
      run: async () => {
        ...
        if (res.status !== 200) {
          throw new Error(`expected 200 from export endpoint, got ${res.status}`);
        }
